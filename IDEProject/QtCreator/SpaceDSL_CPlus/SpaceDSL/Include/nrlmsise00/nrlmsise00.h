...
struct SPACEDSL_API nrlmsise_flags
{
	int switches[24];
	double sw[24];
	double swc[24];
...
struct SPACEDSL_API nrlmsise_input
{
...
struct SPACEDSL_API nrlmsise_output
{
 ...
 *   exosphere.
 */
void  SPACEDSL_API gtd7 (struct nrlmsise_input *input,
 ...
 *   additional details.
 */
void  SPACEDSL_API gtd7d(struct nrlmsise_input *input,
                        struct nrlmsise_flags *flags,
                        struct nrlmsise_output *output);
 ...
 */
void  SPACEDSL_API gts7 (struct nrlmsise_input *input,
                        struct nrlmsise_flags *flags,
                        struct nrlmsise_output *output);
 ...
 *   an altitude.
 */
void  SPACEDSL_API ghp7 (struct nrlmsise_input *input,
                        struct nrlmsise_flags *flags,
                        struct nrlmsise_output *output,
                        double press);
