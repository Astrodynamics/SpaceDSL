...
#include "SpaceDSL/nrlmsise00/nrlmsise00.h"   /* header for nrlmsise-00.h */
...
namespace SpaceDSL {
    ...
    NRLMSISE00::NRLMSISE00()
    {
        ...
        /* DMIX */
        dm04= 0.0; dm16= 0.0; dm28= 0.0; dm32= 0.0; dm40= 0.0; dm01= 0.0; dm14= 0.0;
        ...
        meso_tn1 = new double[5]();
        //static double meso_tn2[4];
        meso_tn2= new double[4]();
        //static double meso_tn3[5];
        meso_tn3= new double[5]();
        //static double meso_tgn1[2];
        meso_tgn1= new double[2]();
        //static double meso_tgn2[2];
        meso_tgn2= new double[2]();
        //static double meso_tgn3[2];
        meso_tgn3= new double[2]();
        ...
        ctloc= 0.0; stloc= 0.0;
        c2tloc= 0.0; s2tloc= 0.0;
        s3tloc= 0.0; c3tloc= 0.0;
        apdf= 0.0;
        //static  apt[4];
        apt= new double[4]();
    ...
    void NRLMSISE00::tselec(struct nrlmsise_flags *flags) {
        int i;
        for (i=0;i<24;i++) {
            if (i!=9) {
    ...
    void NRLMSISE00::glatf(double lat, double *gv, double *reff) {
    ...
    double NRLMSISE00::ccor(double alt, double r, double h1, double zh) {
    ...
    double NRLMSISE00::ccor2(double alt, double r, double h1, double zh, double h2) {
    /*        CHEMISTRY/DISSOCIATION CORRECTION FOR MSIS MODELS
     *         ALT - altitude
     *         R - target ratio
     *         H1 - transition scale length
    ...
    double NRLMSISE00::scalh(double alt, double xm, double temp) {
        double g;
        double rgas=831.4;
    ...
    double NRLMSISE00::dnet (double dd, double dm, double zhm, double xmm, double xm) {
    ...
    void NRLMSISE00::splini (double *xa, double *ya, double *y2a, int n, double x, double *y) {
    ...
    void NRLMSISE00::splint (double *xa, double *ya, double *y2a, int n, double x, double *y) {
    ...
    void NRLMSISE00::spline (double *x, double *y, int n, double yp1, double ypn, double *y2) {
    ...
    double NRLMSISE00::densm (double alt, double d0, double xm, double *tz, int mn3, double *zn3, double *tn3, double *tgn3, int mn2, double *zn2, double *tn2, double *tgn2) {
    ...
    double NRLMSISE00::densu (double alt, double dlb, double tinf, double tlb, double xm, double alpha, double *tz, double zlb, double s2, int mn1, double *zn1, double *tn1, double *tgn1) {
    ...
    double NRLMSISE00::globe7(double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
    ...
    double NRLMSISE00::glob7s(double *p, struct nrlmsise_input *input, struct nrlmsise_flags *flags) {
     ...
     */
        ...
        if (p[99]!=pset) {
            throw SpaceDSL::SPException(__FILE__, __FUNCTION__, __LINE__,
                                        "NRLMSISE-00:Wrong parameter set for glob7s");
    ...
    void NRLMSISE00::gtd7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
        double xlat;
        double xmm;
        int mn3 = 5;
    ...
    void NRLMSISE00::gtd7d(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
    ...
    void NRLMSISE00::ghp7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output, double press) {
        ...
        do {
            ...
            if (l==ltest) {
                throw SpaceDSL::SPException(__FILE__, __FUNCTION__, __LINE__,
                                            "NRLMSISE-00:ERROR: ghp7 not converging for press");
    ...
    void NRLMSISE00::gts7(struct nrlmsise_input *input, struct nrlmsise_flags *flags, struct nrlmsise_output *output) {
